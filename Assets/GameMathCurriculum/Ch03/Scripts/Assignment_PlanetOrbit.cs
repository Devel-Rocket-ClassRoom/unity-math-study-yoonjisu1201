...
public class Assignment_PlanetOrbit : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        planetWorldPos = planetMatrix.MultiplyPoint3x4(new Vector3(planetOrbitRadius, 0, 0));
        ...
        satelliteWorldPos = satelliteMatrix.MultiplyPoint3x4(new Vector3(satelliteOrbitRadius, 0, 0));
