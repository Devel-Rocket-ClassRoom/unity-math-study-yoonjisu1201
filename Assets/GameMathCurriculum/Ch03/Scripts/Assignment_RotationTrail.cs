...
public class Assignment_RotationTrail : MonoBehaviour
{
    ...
    private void Update()
    {
        ...
        Matrix4x4 Matrix = Matrix4x4.TRS(Vector3.zero, Quaternion.Euler(0f, 0f, rotationAngle), Vector3.one);
        Vector3 trailWorldPos = Matrix.MultiplyPoint3x4(new Vector3(armLength, 0, 0));
        transform.position = trailWorldPos;
